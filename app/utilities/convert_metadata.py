...
from app.metadata.armies import metadata_armies_all
import app.metadata.armies as armies
...
def build_race_table():
    ...
    df.to_csv('app/static/dist/modifiers.csv')
...
def build_modifier_table():
    ...
    df.to_csv('app/static/dist/armies.csv')
