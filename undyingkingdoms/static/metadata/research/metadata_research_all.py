...
generic_technology = [
    ...
    Technology(
        ...
        cost=500,
        max_level=3,
        description='Each level raises your maximum mana by {output}.',
        output=20,
    ),
]


def build_tech_dict(techs):
...
generic_technology = build_tech_dict(generic_technology)

test_requirements = {
    'agriculture ii': ['agriculture']
}
