...
class Trade(GameEvent):
    ...
    def __init__(self, county_id, target_id, world_day, duration, gold_to_give=0, wood_to_give=0, iron_to_give=0,
                 gold_to_receive=0, wood_to_receive=0, iron_to_receive=0):
